...
export default function UserProfile() {
  ...
  useEffect(() => {
    if (status === "authenticated" && session) {
      const fetch = async () => {
        ...
        if (user.data.name !== decodedUsername) {
          setRedirecting(true);
  ...
  if (status === "loading" || redirecting) return null;
              ...
              <div className="flex-1 space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <button
                    ...
                    className="flex cursor-pointer items-center gap-2 px-4 py-2 bg-slate-800/50 hover:bg-slate-700/50 border border-slate-600/50 rounded-xl text-gray-300 hover:text-white transition-all duration-300"
                  >
              ...
              <div className="p-6 border-b border-slate-700/50">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-2 cursor-pointer hover:bg-slate-800/50 rounded-lg text-gray-400 hover:text-white transition-colors"
                  >
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-slate-800/30 border border-slate-700/30 rounded-xl">
                      ...
                      <div className="text-sm text-gray-400">
                        ...
                        <p>
                          Email and phone number cannot be changed for security
                          reasons.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex gap-3 mt-6">
                    <button
                      type="button"
                      onClick={handleCloseModal}
                      className="flex-1 cursor-pointer px-4 py-3 text-gray-400 hover:text-white hover:bg-slate-800/50 border border-slate-700/50 rounded-xl transition-all duration-300"
                    >
                      Cancel
                    </button>
                    <button
