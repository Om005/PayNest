      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-lg">Choose a contact and send money instantly</p>
          </div>
                ...
                <div className="p-6">
                  {filteredContacts.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 mb-4">Try adjusting your search or add a new contact</p>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center shadow-lg">
                              {contact.avatar ? (
                                ...
                                <span className="text-white font-semibold text-lg">{contact.name.charAt(0)}</span>
                              )}
                            </div>
                            ...
                            <div>
                              <div className="flex items-center gap-2 mb-1">
                                ...
                                {contact.isFrequent && <IconStar className="w-4 h-4 text-yellow-400 fill-current" />}
                                <span
                                  className={`px-2 py-1 rounded-lg text-xs font-medium border ${getStatusColor(contact.status)}`}
                                >
                          ...
                          <div className="text-right">
                            ...
                            {contact.lastTransaction && (
                              <div className="text-xs text-gray-500">
                                Last: {new Date(contact.lastTransaction).toLocaleDateString()}
                              </div>
                            )}
                ...
                {showSendForm && selectedContact ? (
                  <div className="p-6">
                    <div className="text-center mb-6">
                      <h3 className="text-xl font-bold text-white mb-2">Send Money</h3>
                      <div className="flex items-center justify-center gap-3 p-3 bg-slate-800/50 rounded-xl">
                        <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center">
                          <span className="text-white font-semibold">{selectedContact.name.charAt(0)}</span>
                        </div>
                        <div className="text-left">
                          <div className="font-semibold text-white">{selectedContact.name}</div>
                  ...
                  <div className="p-6 text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-400 mb-2">Select a Contact</h3>
                    <p className="text-gray-500 text-sm">Choose someone from your contacts to send money to</p>
                  </div>
                )}
              </div>
            </div>
